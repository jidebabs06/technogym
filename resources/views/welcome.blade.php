...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            {{-- <a class="navbar-brand" href="index.html">Techno Gym</a> --}}
            <img src="images/Technogym_Logo.png" class="navbar-brand" alt="Class" width="150px" height="50px">
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h6 data-aos="fade-up" data-aos-delay="300">Technogym Run</h6>

                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Every Revolution Starts With A Step</h1>

                                    <a href="/register" class="btn custom-btn mt-3" data-aos="fade-up" data-aos-delay="600">Get started</a>
                            ...
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="class-thumb">
                                    ...
                                    <div class="class-info">
                                        ...
                                        <span class="class-price">{{$plan->plan_price}}</span>

                                        <p class="mt-3">{{$plan->plan_details}}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                        ...
                        <form action="{{ route('contact.send') }}" method="POST" class="contact-form webform" data-aos="fade-up" data-aos-delay="400" role="form">
                            @csrf
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="membership-form webform" role="form" method="POST" >
                ...
                <input type="tel" class="form-control" name="phoneno" placeholder="123-456-7890" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
